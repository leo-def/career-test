...
public interface IUniversityRestRepository extends PagingAndSortingRepository<University, Long>{

	@RestResource(exported=false)
	@Query("SELECT e.id, e.title FROM University e")
	public List<Object[]> findIdAndTitle();

	@RestResource(exported=false)	
	@Query(value = "select new com.pp.careertest.dto.SelectOptionDTO(e.id, e.title) FROM University e")
